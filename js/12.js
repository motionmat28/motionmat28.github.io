if (typeof adcValid !== 'object') var adcValid = {};
...
adcValid.errorMes = {
  ...
  mes: function (elem, msg) {
    ...
    _t.add.animate({scrollTop: y - 50}, 0, function () {
      style = 'left: ' + x + 'px;' +
      'top: ' + (y - 36) + 'px;' +
...
adcValid.validation = {
  ...
  init: function (button, fullAddress) {
    var _t = this,
    errorText = {
    ...
    for (var ekey in errorText) {
      if (typeof defaults === 'object' && errorText[ekey][1]) errorText[ekey][0] = defaults.get_locale_var(errorText[ekey][1]);
    }
    ...
    if (!_t.cleaning(_t.input.name.val())) {
      ...
      if (typeof fullAddress === 'object' && !fullAddress.length) {
        _t['fullAddress'] = [];
    ...
    function check_form(target) {
        ...
        var feed = {
            ...
            submit: function(form, callback) {
                ...
                if(!rephone.test(postParams.phone) || postParams.phone.length < 6)
    ...
    locale: {
        ...
        br:{
          ...
          set_house: 'House is a required field',
            error_fio: 'Por gentileza, verifique os seus dados',
          	...
          	set_address: 'Address is a required field',
          	set_city: 'City is a required field',
            set_phone: 'Por gentileza, verifique os seus dados',
            error_phone: 'Por gentileza, verifique os seus dados',
        ...
        ja:{
      	...
      	nl:{
            ...
            error_fio: 'Naam achternaam zijn niet correct ingevuld',
            set_phone: 'Je hebt telefoonnummer niet ingevuld',
          	set_comment: 'Vertel over je probleem',
            set_address: 'Vul het adres is',
          	error_address: 'Ongeldig Adres, vul alstublieft het formulier opnieuw in',
        ...
        sr:{
          ...
          set_house: 'House is a required field',
            ...
            error_fio: 'Invalid format Ime',
          	error_address: 'Invalid address, please, refill the form',
            set_phone: 'Niste uneli broj telefona',
        ...
        cs:{
          ...
          error_address: 'Invalid address, please, refill the form',
          error_fio: 'Εισάγετε σωστό όνομα' ,
          set_address: 'Address is a required field',
          set_house: 'House is a required field',
          set_city: 'City is a required field',
        ...
        lt: {
          set_fio: 'Vardo laukelis yra privalomas',
          error_fio: 'Vardo laukelis užpildytas netinkamai',
          set_phone: 'Telefono numerio laukelis yra privalomas',
          error_phone: 'Telefono numeris įvestas netinkamai',
        },
        ka: {
          set_fio: 'სახელი სავალდებულო ველია',
          error_fio: 'სახელის ველი შევსებულია არასწორად',
          set_phone: 'ტელეფონის ნომერი სავალდებულო ველია',
          error_phone: 'ტელეფონის ნომერი შევსებულია არასწორად',
        }
    }
};
